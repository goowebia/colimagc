import{t as e}from"./main-CTM-C1Mc.js";function t(e){let t=[`./imagenes/DJI_0001.JPG`,`./imagenes/DJI_0002.JPG`,`./imagenes/DJI_0003.JPG`,`./imagenes/DJI_0004.JPG`,`./imagenes/DJI_0008.JPG`,`./imagenes/DJI_0012.JPG`,`./imagenes/DJI_0013.JPG`,`./imagenes/DJI_0014.JPG`,`./imagenes/DJI_0015.JPG`,`./imagenes/DJI_0016.JPG`,`./imagenes/DJI_0017.JPG`];e.innerHTML=`
        <div class="min-h-screen bg-slate-950 text-slate-100 font-display selection:bg-primary selection:text-slate-950">
            ...
            <section id="inicio" class="relative min-h-[92vh] flex items-center justify-center overflow-hidden pt-8 pb-16 px-4">
                ...
                <div id="hero-slider" class="absolute inset-0 z-0">
                    ${t.map((e,t)=>`
                        <div class="hero-slide absolute inset-0 bg-cover bg-center transition-opacity duration-1000 ease-in-out ${t===0?`opacity-100 scale-105`:`opacity-0 scale-100`}"
                            style="background-image: url('${e}'); filter: brightness(0.65) contrast(1.10);"></div>
                    `).join(``)}
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 pt-4">
                    ${t.slice(0,6).map((e,t)=>`
                        <div class="group relative rounded-3xl overflow-hidden border border-slate-800 aspect-[4/3] bg-slate-900 shadow-xl">
                            <img src="${e}" alt="Club de Golf Colima Dron" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" loading="lazy">
    ...
    `,n()}function n(){let e=0;setInterval(()=>{let t=document.querySelectorAll(`.hero-slide`);!t||t.length===0||(t[e].classList.remove(`opacity-100`,`scale-105`),t[e].classList.add(`opacity-0`,`scale-100`),e=(e+1)%t.length,t[e].classList.remove(`opacity-0`,`scale-100`),t[e].classList.add(`opacity-100`,`scale-105`))},4500)}e((()=>{}))();export{t as renderLandingPageModule};